  ...
  const onSubmit = async (data: LoginInput) => {
    ...
    try {
      ...
      if (code === 'auth/email-not-verified') {
        setError('E-postanızı doğrulayın. Yeni doğrulama e-postası gönderildi.');
      } else {
    ...
    <div className="min-h-screen bg-brand-lightBg flex items-center justify-center p-4">
      <div className="card max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-brand-fume">Hesabına giriş yap</p>
        </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-sm text-brand-fume">veya</span>
          <div className="flex-1 h-px bg-brand-border" />
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="text-sm font-heading font-semibold text-black">
                Şifre
              </label>
              <Link href="/forgot-password" className="text-xs text-brand-intLink hover:underline">
                Şifremi unuttum
              </Link>
            </div>
            <input
        ...
        <p className="text-center text-sm text-brand-fume mt-6">
          Hesabın yok mu?{' '}
          <Link href="/signup" className="text-brand-intLink font-semibold hover:underline">
            Kayıt Ol
          </Link>
        </p>
      </div>
